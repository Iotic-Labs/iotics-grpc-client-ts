...
goog.exportSymbol('proto.iotics.api.RequestInfo', null, global);
 ...
 * @constructor
 */
proto.iotics.api.RequestInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.iotics.api.RequestInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.iotics.api.RequestInfo.displayName = 'proto.iotics.api.RequestInfo';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.iotics.api.RequestInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.iotics.api.RequestInfo.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.iotics.api.RequestInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.iotics.api.RequestInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    starttime: (f = msg.getStarttime()) && google_protobuf_timestamp_pb.Timestamp.toObject(includeInstance, f),
    tracectxMap: (f = msg.getTracectxMap()) ? f.toObject(includeInstance, undefined) : []
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.iotics.api.RequestInfo}
 */
proto.iotics.api.RequestInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.iotics.api.RequestInfo;
  return proto.iotics.api.RequestInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.iotics.api.RequestInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.iotics.api.RequestInfo}
 */
proto.iotics.api.RequestInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.iotics.api.RequestInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.iotics.api.RequestInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.iotics.api.RequestInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.iotics.api.RequestInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.iotics.api.RequestInfo.prototype.getStarttime = function() {
 ...
 * @return {!proto.iotics.api.RequestInfo} returns this
*/
proto.iotics.api.RequestInfo.prototype.setStarttime = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.iotics.api.RequestInfo} returns this
 */
proto.iotics.api.RequestInfo.prototype.clearStarttime = function() {
 ...
 * @return {boolean}
 */
proto.iotics.api.RequestInfo.prototype.hasStarttime = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 */
proto.iotics.api.RequestInfo.prototype.getTracectxMap = function(opt_noLazyCreate) {
 ...
 * @return {!proto.iotics.api.RequestInfo} returns this
 */
proto.iotics.api.RequestInfo.prototype.clearTracectxMap = function() {
  this.getTracectxMap().clear();
  return this;};
...
proto.iotics.api.Headers.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    requestinfo: (f = msg.getRequestinfo()) && proto.iotics.api.RequestInfo.toObject(includeInstance, f)
  };
...
proto.iotics.api.Headers.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = new proto.iotics.api.RequestInfo;
      reader.readMessage(value,proto.iotics.api.RequestInfo.deserializeBinaryFromReader);
...
proto.iotics.api.Headers.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      proto.iotics.api.RequestInfo.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional RequestInfo requestInfo = 6;
 * @return {?proto.iotics.api.RequestInfo}
 */
proto.iotics.api.Headers.prototype.getRequestinfo = function() {
  return /** @type{?proto.iotics.api.RequestInfo} */ (
    jspb.Message.getWrapperField(this, proto.iotics.api.RequestInfo, 6));
};


/**
 * @param {?proto.iotics.api.RequestInfo|undefined} value
 * @return {!proto.iotics.api.Headers} returns this
*/
proto.iotics.api.Headers.prototype.setRequestinfo = function(value) {
 ...
 * @return {!proto.iotics.api.Headers} returns this
 */
proto.iotics.api.Headers.prototype.clearRequestinfo = function() {
 ...
 * @return {boolean}
 */
proto.iotics.api.Headers.prototype.hasRequestinfo = function() {
