...
SearchAPI.AdvancedSearch = {
  ...
  requestStream: false,
  responseStream: true,
  requestType: iotics_api_search_pb.AdvancedSearchRequest,
  responseType: iotics_api_search_pb.SearchResponse
};
...
SearchAPIClient.prototype.advancedSearch = function advancedSearch(requestMessage, metadata) {
  var listeners = {
    data: [],
    end: [],
    status: []
  };
  var client = grpc.invoke(SearchAPI.AdvancedSearch, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
